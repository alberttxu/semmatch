...
def test_templateMatch():
    ...
    assert coords == [(2149, 1904), (2637, 1448), (1732, 1229), (2239, 1535),
                      (2293, 2128), (2897, 1120), (2111, 2088), (1769, 1044),
                      (2819, 1488), (2019, 1680), (2095, 1311), (2598, 1633)]

def test_defocusCorrectedCoords1():
    coords = [(2149, 1904), (2637, 1448), (1732, 1229), (2239, 1535),
              (2293, 2128), (2897, 1120), (2111, 2088), (1769, 1044),
              (2819, 1488), (2019, 1680), (2095, 1311), (2598, 1633)]
...
def test_defocusCorrectedCoords3():
    ...
    correctedCoords = defocusCorrectedCoords(coords, center, theta=-4.134216, scale=1.011296)
    assert correctedCoords == [(2166, 1878), (2625, 1383), (1698, 1228), (2230, 1500),
                               (2328, 2093), (2864, 1033), (2141, 2066), (1721, 1039),
                               (2812, 1410), (2019, 1662), (2069, 1285), (2599, 1573)]
...
def test_writeToNavFile():
    ...
    navPts = coordsToNavPoints(coords, mapSection, startLabel=9000, acquire=1,
                               groupOpt=0, groupRadiusPix=123)[0]
